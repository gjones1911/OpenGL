...
//calculate normals
function CalcNorm(v1, v2, v3, vec)
{
	var u = [];
	var v = [];
...
//	console.log("vec1: ",+vec[v1*3]+" "+vec[v1*3+1]+" "+vec[v1*3+2]);
//	console.log("vec2: ",+vec[v2*3]+" "+vec[v2*3+1]+" "+vec[v2*3+2]);
//	console.log("vec3: ",+vec[v3*3]+" "+vec[v3*3+1]+" "+vec[v3*3+2]);

	u[0] = vec[v2*3] - vec[v1*3];
	u[1] = vec[v2*3+1] - vec[ v1*3+1];
	u[2] = vec[ v2*3+2] - vec[v1*3+2];

	v[0] = vec[v3*3+0] - vec[v1*3+0];
	v[1] = vec[v3*3+1] - vec[v1*3+1];
	v[2] = vec[v3*3+2] - vec[v1*3+2];
