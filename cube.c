...
//top
	...
	GLfloat * *vptr = ( GLfloat * *) malloc( sizeof( GLfloat *) * 24);

	GLfloat vA[3] = {1,1,1};		//0
	GLfloat vB[3] = {0,1,1};		//1
	GLfloat vC[3] = {0,0,1};		//2
	GLfloat vD[3] = {1,0,1};		//3
	GLfloat vE[3] = {1,1,0};		//4
	GLfloat vF[3] = {0,1,0};		//5
	GLfloat vG[3] = {0,0,0};		//6
	GLfloat vH[3] = {1,0,0};		//7
//shape 
//0
	vptr[0] = vA;
	vptr[1] = vB;
