...
/*
    ...
    GC.normlAttribute = gl.getAttribLocation(this.shaderProgram, "normal");
    gl.enableVertexAttribArray(GC.normlAttribute);

    GC.lightposAttribute = gl.getAttribLocation(this.shaderProgram, "lightpos");
    gl.enableVertexAttribArray(GC.lightposAttribute);
*/    
...
demo.prototype.initGeometryBuffers = function(){
  ...
  var max = [-90000,-90000,-90000]; //used for bounding box calculations
    ...
    m.indices.forEach(function(d,i){
		...
		if( d == 0 && cnt < 1)
		{
			console.log("d: "+d+" ,n1: "+m.norml[d*3]+","+m.norml[d*3+1]+","+m.norml[d*3+2]);
			cnt += 1;
		}
